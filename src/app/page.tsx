    ...
    <main className="relative min-h-screen bg-[#070707] text-[#dcdcdc] font-sans">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden bg-[#070707]">
        <div className="z-10 max-w-5xl space-y-6">
          ...
          <div className="pt-12">
            <Link href="/events" className="inline-block border border-[#b49b5c] text-[#b49b5c] px-10 py-3 rounded-none uppercase tracking-widest text-sm hover:bg-[#b49b5c] hover:text-[#070707] transition-all duration-300">
              Explore Events
            </Link>
          </div>
        </div>
